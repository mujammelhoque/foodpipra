...
<div class="login-box">
    <div class="card card-outline card-primary" style="width: 450px">
      <div class="card-header text-center">
        <a href="{{ asset('assets')}}/index2.html" class="h1"><b>Admin  </b>Register</a>
      </div>
      <div class="card-body" >
        <form action="{{ route('admin.create') }}" method="post">
          ...
          <div class="input-group mb-3">
            <input name="org_name" type="text" class="form-control" placeholder="Enter your company name">
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3">
            <input name="business_type" type="text" class="form-control" placeholder="Enter your business type">
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3">
            <input name="address" type="text" class="form-control" placeholder="Enter your business address">
            <div class="input-group-append">
              <div class="input-group-text">
