...
<div class="offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12 padding">
  <form  action="{{ route('admin.order.position') }}" method="post">
    @csrf
  ...
  <a class="btn btn-success btn-sm" href="{{ route('admin.deliver.order.pdf',$order->id) }}">Download</a>
  <br>
  <div class="card">
  ...
  <div><span>district:{{ App\Models\Location::find($order->location_id)->location}} </span> |<span>Sub district: {{ App\Models\Location::find($order->sublocation_id)->location}}</span></div>
