    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="mb-2">
            <button class="btn btn-primary" @if (Auth::guard('seller')->user()->seller_rule == 0)
              disabled
            @endif type="submit">Submit</button>
            @if (Auth::guard('seller')->user()->seller_rule == 0)
              You have no access to upload product. Please contact to Admin
            @endif
          </div>
         </form>
          <!-- /.card-body -->
  ...
  <script type=text/javascript>
    $(document).ready(function(){
      ...
      if(categoryId){
        $.ajax({
          type:"GET",
          url:"{{url('seller/getSubCategory')}}?category_id="+categoryId,
